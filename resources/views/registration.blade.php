                                ...
                                <div class="col-xs-12 card">
                                    <div class="col-xs-10 col-xs-offset-1 bk-light">
                                        ...
                                        <div class="form-group field-wrapper1">
                                            ...
                                            <select class="form-control" name="hear_us" id="hear_us" tabindex="" data-validation="required" data-validation-optional="false"  data-validation-error-msg="Select Your Choice ">
                                                ...
                                                <option value="Chola Employee Referral">Chola Employee Referral</option>

                                            </select>
                                        </div>

                                        <div class="form-group field-wrapper1" id="acquisition_details_div">
                                            <label>Mobile Number of Chola Employee</label>
                                            <input type="tel" placeholder="Mobile Number of Chola Employee" class="form-control data-number" name="acquisition_details" id="acquisition_details" maxlength="10" tabindex="" data-validation="required,length" data-validation-optional="false" data-validation-length="8-10" data-validation-error-msg="Please Enter Mobile Number of Chola Employee" value="{{old('acquisition_details')}}">
                                        </div>
...
$('#submitbtn').html('Get Started');
            ...
            var temp = 0;
            var msg = "";
            var hear_us = $("#hear_us").val();
            
            if ($('#dealer_name').val() == "" && $('#d_email').val() == "" && $('#d_mobileno').val() == "") {
            msg = "All fields are required. ";
            temp++;
            }
            if((hear_us=='Chola Employee Referral'&&$('#acquisition_details').val()=='')&&parseFloat(temp)<=0){
             msg = "All fields are required. ";
             temp++;   
            }
            ...
            $('#acquisition_details_div').hide();
            $("#hear_us").change(function () {
                
                if($(this).val()=='Chola Employee Referral')
                {
                    $('#acquisition_details_div').show();
                }
                else{
                    $('#acquisition_details_div').hide();
                }

...
class loanmodel extends Eloquent
{
	...
	public static function doFetchloanDetails($where)
	{
		$dealer_id 	= 	schemaconnection::masterconnection()
						...
						->select('car_id',DB::raw("dealer_customer_loan_id,lead_id,customer_id,customername,customermobileno,
    ...
    */
    ...
    public static function loanapitest($schemaname,$customerId="")
    {
        commonmodel::doschemachange($schemaname);
        return schemaconnection::dmsmysqlconnection()
                                            ->table('dealer_contact_management')
                                            ->where('contact_management_id',$customerId)
                                            ->get();
    }

    public static function getModelID($schemaname,$carId)
    {
        commonmodel::doschemachange($schemaname);
        return schemaconnection::dmsmysqlconnection()
                                            ->table('dms_car_listings')
    ...
    public static function getModelName($schemaname,$modelId)
    {
    ...
    public static function leadApiTestStatus($leadID,$scheamid)
    {
        
        //$scheamid= 'dmschema_14876824222';
        //$scheamid= commonmodel::doschemachange('dmschema_14876824222');
        // dd(schemaconnection::masterconnection()
        //     ->table('dms_dev.dealer_customerloan_details')
        //     ->where('lead_id',$leadID)
        //     ->leftjoin('dmschema_14876824222.dealer_contact_management','dmschema_14876824222.dealer_contact_management.contact_management_id','=','dms_dev.dealer_customerloan_details.lead_id')
        //     ->leftjoin('dms_dev.dealer_contact_type','dms_dev.dealer_contact_type.contact_type_id','=','dealer_contact_management.contact_type_id')
        //     ->get());
        return schemaconnection::masterconnection()
            ->table('dms_dev.dealer_customerloan_details')
            ->where('lead_id',$leadID)
            ->leftjoin($scheamid.'.dealer_contact_management',$scheamid.'.dealer_contact_management.contact_management_id','=','dms_dev.dealer_customerloan_details.lead_id')
            ->leftjoin('dms_dev.dealer_contact_type','dms_dev.dealer_contact_type.contact_type_id','=','dealer_contact_management.contact_type_id')
            ->get();
    }
}

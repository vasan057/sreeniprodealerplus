...
Route::any('/loanApi/{scheamid?}/{customerId?}/{loanAmount?}/{lastid?}/{carId?}','testController@loanApi');
Route::any('/leadApiTestAjax','api\loan@leadApiTestAjax');
Route::any('leadApiTest/{customerId?}','api\loan@leadApiTest');
Route::any('/createLead','api\loan@createLead');
